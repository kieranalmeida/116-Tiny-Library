...
export default function AboutPage(): JSX.Element {
    return (
        <main className="flex flex-col items-center text-neutral-950 -mt-10 mb-10 lg:mt-0">
            ...
            {/* Section 1 */}
            <section className="flex flex-col p-5 lg:flex-row lg:items-center lg:gap-x-25">
                <img className="lg:w-full lg:max-w-162.5" src="/hero-image-mobile.svg"/>
                ...
                <div className="flex flex-col items-start mt-5 lg:w-200">
                    ...
                    <Link 
                        className="inline-block text-[1.25rem] font-semibold uppercase mt-18.25 px-7.5 py-2 border-2 border-neutral-950 cursor-pointer hover:text-neutral-50 hover:bg-neutral-950" href="/about/contact"
                    >
                        Contact Us
                    </Link>
                </div>
            ...
            {/* Section 2 */}
            <section className="flex flex-col gap-y-12 my-7 py-7 px-5 border-t border-b border-[#DDDDDD] lg:flex-row lg:justify-center lg:gap-x-12 lg:w-full">
            ...
            {/* Section 3 */}
            <section className="p-5 lg:w-200">
                <div>
                    ...
                    <hr className="w-61.25 mx-auto my-10"/>
